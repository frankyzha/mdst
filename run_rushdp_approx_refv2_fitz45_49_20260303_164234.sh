#!/bin/bash
#SBATCH --job-name=rushdp_apx_refv2
...
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_approx_refv2_fitz45_49_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_approx_refv2_fitz45_49_%j.err
...
RUN_NAME="benchmark_rushdp_3h_s1_20260228_095759_refv2_$(date +%Y%m%d_%H%M%S)"
