...
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260303_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260303_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260303 \
  --datasets eye-state \
  --depth-budgets 4 \
  --seeds 0 \
  --time-limit 10800 \
