#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_v94
#SBATCH --output=msdt_tga_elec_d3_v94_%j.out
#SBATCH --error=msdt_tga_elec_d3_v94_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_shallowcheapub_20260315_v94 \
