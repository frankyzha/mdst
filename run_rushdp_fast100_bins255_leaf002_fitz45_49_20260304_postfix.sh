#!/bin/bash
#SBATCH --job-name=rush255_lf02_fix
...
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260304_postfix_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260304_postfix_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_rushdp_fast100_bins255_leaf002_fitz45_49_20260304_postfix \
  --datasets eye-state \
  --depth-budgets 4 \
  --seeds 0 \
  --time-limit 10800 \
