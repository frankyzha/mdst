#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d4_l3_a0f
#SBATCH --output=msdt_tga_elec_d4_l3_a0f_%j.out
#SBATCH --error=msdt_tga_elec_d4_l3_a0f_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d4_l3_k3_atom0_fix_20260316 \
