#!/usr/bin/env bash
#SBATCH --job-name=msdt_atom_elec_d4_opt7
#SBATCH --output=msdt_atom_elec_d4_opt7_%j.out
#SBATCH --error=msdt_atom_elec_d4_opt7_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_atomcolor_electricity_d4_reg0_rununion_opt_20260310_v8 \
