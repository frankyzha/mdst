#!/usr/bin/env bash
#SBATCH --job-name=el_d4_b255_l255
...
#SBATCH --output=results/runtime_compare_jobs/electricity_d4_bins255_only_leaf001_%j.out
#SBATCH --error=results/runtime_compare_jobs/electricity_d4_bins255_only_leaf001_%j.err
set -euo pipefail
