#!/bin/bash
#SBATCH --job-name=rushdp_xlazy_adapk
#SBATCH --partition=compsci
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128G
#SBATCH --time=04:00:00
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_3h_s1_exactlazy_adaptivek_20260301_195117_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_3h_s1_exactlazy_adaptivek_20260301_195117_%j.err
