#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d4_l3_r0_v37
#SBATCH --output=msdt_tga_elec_d4_l3_r0_v37_%j.out
#SBATCH --error=msdt_tga_elec_d4_l3_r0_v37_%j.err
...
export MSPLIT_TEACHER_PAIR_ONE_PER_FEATURE=1

/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d4_l3_reg0_v37 \
