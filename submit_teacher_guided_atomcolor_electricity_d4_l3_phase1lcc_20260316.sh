#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d4_l3_lcc1
#SBATCH --output=msdt_tga_elec_d4_l3_lcc1_%j.out
#SBATCH --error=msdt_tga_elec_d4_l3_lcc1_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d4_l3_phase1lcc_20260316 \
