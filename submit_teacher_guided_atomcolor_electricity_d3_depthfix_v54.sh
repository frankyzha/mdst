#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_v54
#SBATCH --output=msdt_tga_elec_d3_v54_%j.out
#SBATCH --error=msdt_tga_elec_d3_v54_%j.err
...
export MSPLIT_DEBUG_DEPTH1_LEAF_GAP=1

/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_depthgap_20260314_v54 \
