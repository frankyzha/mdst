...
#SBATCH --output=results/runtime_compare_jobs/cmp_fill_pt2_%j.out
#SBATCH --error=results/runtime_compare_jobs/cmp_fill_pt2_%j.err
...
PROFILE_PREFIX="results/runtime_compare_jobs/${RUN_NAME}_pt2_${SLURM_JOB_ID}"
