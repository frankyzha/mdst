#!/usr/bin/env bash
#SBATCH --job-name=msdt_rc_all_d4
#SBATCH --output=msdt_rc_all_d4_%j.out
#SBATCH --error=msdt_rc_all_d4_%j.err
...
export MSPLIT_RUNCOLOR_SCOPE=all
.venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_distilled_runcolor_allnodes_electricity_d4_20260309 \
