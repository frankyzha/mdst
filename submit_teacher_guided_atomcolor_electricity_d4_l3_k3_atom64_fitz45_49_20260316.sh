#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d4_l3_a64
#SBATCH --output=msdt_tga_elec_d4_l3_a64_%j.out
#SBATCH --error=msdt_tga_elec_d4_l3_a64_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d4_l3_k3_atom64_20260316 \
