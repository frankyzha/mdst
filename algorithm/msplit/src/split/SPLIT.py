...
from .utils import tree_to_dict
...
class SPLIT:
    ...
    def train_greedy(self, X_train,y_train,depth_budget,reg):
        ...
        if depth_budget > 1 and flag: 
            ...
            X_train_left = X_train[X_train.iloc[:, best_feature] == 1]
            y_train_left = y_train[X_train.iloc[:, best_feature] == 1]

            X_train_right = X_train[X_train.iloc[:, best_feature] == 0]
            y_train_right = y_train[X_train.iloc[:, best_feature] == 0]
    ...
    def fill_leaves_with_greedy(self,tree,X_train,y_train):
        ...
        if isinstance(tree, Leaf):
            ...
            X_left = X_train[X_train.iloc[:, tree.feature] == 1]
            y_left = y_train[X_train.iloc[:, tree.feature] == 1]
            X_right = X_train[X_train.iloc[:, tree.feature] == 0]
            y_right = y_train[X_train.iloc[:, tree.feature] == 0]
