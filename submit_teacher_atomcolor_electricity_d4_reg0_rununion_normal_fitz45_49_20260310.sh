#!/usr/bin/env bash
#SBATCH --job-name=msdt_atom_elec_d4
#SBATCH --output=msdt_atom_elec_d4_%j.out
#SBATCH --error=msdt_atom_elec_d4_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_atomcolor_electricity_d4_reg0_rununion_normal_20260310 \
