#!/bin/bash
#SBATCH --job-name=rushdp_exactlazy_samecfg
#SBATCH --partition=compsci-gpu
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128G
#SBATCH --time=06:00:00
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_3h_s1_exactlazy_samecfg_20260301_104851_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_3h_s1_exactlazy_samecfg_20260301_104851_%j.err
