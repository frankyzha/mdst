#!/bin/bash
#SBATCH --job-name=cmp_fill_pt2_r
...
#SBATCH --output=results/runtime_compare_jobs/cmp_fill_pt2_r_%j.out
#SBATCH --error=results/runtime_compare_jobs/cmp_fill_pt2_r_%j.err

set -euo pipefail
cd /home/users/yz1075/msdt
mkdir -p results/runtime_compare_jobs

RUN_NAME="comparison_fast100_all3_d2_6_pb0_em0_bins255_pt8_20260305_083914"
PROFILE_PREFIX="results/runtime_compare_jobs/${RUN_NAME}_pt2_resume_${SLURM_JOB_ID}"
