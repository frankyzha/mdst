#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_l3
#SBATCH --output=msdt_tga_elec_d3_l3_%j.out
#SBATCH --error=msdt_tga_elec_d3_l3_%j.err
#SBATCH --time=08:00:00
#SBATCH --partition=compsci-gpu
#SBATCH --mem=200G
#SBATCH --cpus-per-task=3
#SBATCH --ntasks=1
#SBATCH --nodelist=compsci-cluster-fitz-[45-47]
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_l3_k3_atom32_20260316 \
