#!/bin/bash
#SBATCH --job-name=msdt_rc_prefx6_d4
#SBATCH --partition=compsci-gpu
#SBATCH --nodelist=compsci-cluster-fitz-[45-49]
#SBATCH --nodes=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=700G
#SBATCH --output=/home/users/yz1075/msdt/msdt_rc_prefix_exactopt6_d4_%j.out
#SBATCH --error=/home/users/yz1075/msdt/msdt_rc_prefix_exactopt6_d4_%j.err
...
/home/users/yz1075/msdt/.venv/bin/python /home/users/yz1075/msdt/multisplit_experiment_runner.py \
  --run-name benchmark_distilled_runcolor_prefix_electricity_d4_exactopt6_20260309 \
