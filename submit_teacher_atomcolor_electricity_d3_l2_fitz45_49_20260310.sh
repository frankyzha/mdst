#!/usr/bin/env bash
#SBATCH --job-name=msdt_atom_elec_d3
#SBATCH --output=msdt_atom_elec_d3_%j.out
#SBATCH --error=msdt_atom_elec_d3_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_atomcolor_electricity_d3_l2_20260310 \
