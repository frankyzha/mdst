#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_v92
#SBATCH --output=msdt_tga_elec_d3_v92_%j.out
#SBATCH --error=msdt_tga_elec_d3_v92_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_scalark3reserve2_20260315_v92 \
