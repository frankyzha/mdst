#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_v67
#SBATCH --output=msdt_tga_elec_d3_v67_%j.out
#SBATCH --error=msdt_tga_elec_d3_v67_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_featurewinner_proxyub_20260315_v67 \
