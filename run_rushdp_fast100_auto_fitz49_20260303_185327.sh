#!/bin/bash
#SBATCH --job-name=rushdp_fast100
...
#SBATCH --output=results/runtime_compare_jobs/benchmark_rushdp_fast100_fitz49_%j.out
#SBATCH --error=results/runtime_compare_jobs/benchmark_rushdp_fast100_fitz49_%j.err

set -euo pipefail
cd /home/users/yz1075/msdt
mkdir -p results/runtime_compare_jobs
RUN_NAME="benchmark_rushdp_3h_s1_20260228_095759_fast100_auto_$(date +%Y%m%d_%H%M%S)"
