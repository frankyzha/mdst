#!/usr/bin/env bash
#SBATCH --job-name=msdt_atom_elec_d4_r0_nsdg
#SBATCH --output=msdt_atom_elec_d4_r0_nsdg_%j.out
#SBATCH --error=msdt_atom_elec_d4_r0_nsdg_%j.err
...
export MSPLIT_DEBUG_ATOMCOLOR_EXACT=1

/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_atomcolor_electricity_d4_reg0_noseed_diag_20260309 \
