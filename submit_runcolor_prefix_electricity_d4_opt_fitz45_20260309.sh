#!/usr/bin/env bash
#SBATCH --job-name=msdt_rc_prefix_opt45_d4
#SBATCH --output=msdt_rc_prefix_opt45_d4_%j.out
#SBATCH --error=msdt_rc_prefix_opt45_d4_%j.err
#SBATCH --time=08:00:00
#SBATCH --partition=compsci-gpu
#SBATCH --mem=800G
#SBATCH --cpus-per-task=30
#SBATCH --ntasks=1
#SBATCH --nodelist=compsci-cluster-fitz-45
...
.venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_distilled_runcolor_prefix_electricity_d4_opt_fitz45_20260309 \
