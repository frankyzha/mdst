#!/bin/bash
#SBATCH --job-name=el_d4_b255_lf001
...
#SBATCH --output=results/runtime_compare_jobs/electricity_d4_bins255_probe_leaf001_%j.out
#SBATCH --error=results/runtime_compare_jobs/electricity_d4_bins255_probe_leaf001_%j.err
set -euo pipefail
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name electricity_d4_fast100_bins255_leaf001_probe_l31_20260306_001601 \
  --max-bins 255 \
  --lgb-num-leaves 31 \
  "${COMMON[@]}"
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name electricity_d4_fast100_bins255_leaf001_probe_l255_20260306_001601 \
  --max-bins 255 \
  --lgb-num-leaves 255 \
  "${COMMON[@]}"
