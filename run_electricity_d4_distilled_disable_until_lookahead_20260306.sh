#!/usr/bin/env bash
#SBATCH --job-name=msdt_elec_d4_distill_approx
#SBATCH --output=msdt_elec_d4_distill_approx_%j.out
#SBATCH --error=msdt_elec_d4_distill_approx_%j.err
...
.venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_distilled_electricity_d4_20260306 \
