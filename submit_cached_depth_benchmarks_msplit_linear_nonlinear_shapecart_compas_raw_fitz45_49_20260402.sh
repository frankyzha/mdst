#!/bin/bash
#SBATCH --job-name=cmp_cached_msplit_compas_raw
...
#SBATCH --output=results/runtime_compare_jobs/cmp_cached_msplit_compas_raw_%j.out
#SBATCH --error=results/runtime_compare_jobs/cmp_cached_msplit_compas_raw_%j.err
...
RUN_NAME="cached_msplit_linear_nonlinear_shapecart_compas_raw_$(date +%Y%m%d_%H%M%S)"
RESULTS_ROOT="results/comparison_cached_msplit_linear_nonlinear_shapecart_compas_raw"
