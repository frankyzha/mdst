#!/usr/bin/env bash
#SBATCH --job-name=msdt_tga_elec_d3_l3_r0_v31
#SBATCH --output=msdt_tga_elec_d3_l3_r0_v31_%j.out
#SBATCH --error=msdt_tga_elec_d3_l3_r0_v31_%j.err
...
/usr/bin/time -v .venv/bin/python run_multisplit_experiments_lightgbm.py \
  --run-name benchmark_teacher_guided_atomcolor_electricity_d3_l3_reg0_v31 \
